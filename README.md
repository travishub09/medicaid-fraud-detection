...
> 4. [docs/READING_THE_OUTPUTS.md](docs/READING_THE_OUTPUTS.md) — how to read dossiers, trackers, and reports (for investigators)
> 5. [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md) — plain-English error guide
>
